...
export declare function populateProviderInterface(name: string, type: ProviderType, connect: () => Promise<ApiPromise> | Promise<WebSocketProvider> | Web3 | void, disconnect?: () => void): Promise<{
    name: string;
    api: ApiPromise;
    greet: () => void;
