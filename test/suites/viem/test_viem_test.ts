...
import { PublicClient, formatEther, formatUnits, getContract } from "viem";
  ...
  testCases: ({ context, log, it }) => {
    ...
    it({
      ...
      test: async () => {
        ...
        const contract = getContract({ address, abi: xcAssetAbi, publicClient: api as any as PublicClient });
