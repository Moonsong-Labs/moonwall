...
4. **Use Moonwall Package Version Overrides**
   ...
   If you need to use your project's existing repository with local Moonwall development, use the overrides feature in your project's `package.json`:
...
1. **Enable Debug Logs**
   ...
   ```bash
   DEBUG=moonwall* bunx moonwall test <ENV_NAME>
   ```
...
1. **Run Tests with Verbose Output**
   ...
   ```bash
   bunx moonwall test <ENV_NAME> --verbose
   ```
