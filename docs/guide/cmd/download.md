...
```sh [moonwall]
bunx moonwall download polkadot v1.5.0
```

::: tip
If you have moonwall globally installed, you can omit `bunx` from the command and simply use `moonwall download...`
:::

### Downloading the Latest Moonbeam Client

```sh [moonwall]
bunx moonwall download moonbeam latest
```
